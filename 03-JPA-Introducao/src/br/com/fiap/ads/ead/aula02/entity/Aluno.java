...
public class Aluno implements Serializable{
	...
	@Id /*obrigatorio para nao dar erro*/ 
	@GeneratedValue(generator="aluno", strategy=GenerationType.SEQUENCE) //generator mesmo nome da sequenceGenerator
	private int rm; 
	...
	@Temporal(TemporalType.DATE)		//utiliza somente a data, não me interessa a hora e o Calendar smp tras as horas junto
	...
	private Integer semestre;  		//integer é uma classe o dado começa como null, ao inves de começar com 0 se fosse int
